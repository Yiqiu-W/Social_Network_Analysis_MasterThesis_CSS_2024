...
setwd("mypath")
kbl(df, caption = "Table 8: Results of Meta-Analysis(Disliking Network)", booktabs = T,col.names = c("Effect","Est.","(s.e)."," ","C","Est.","(s.e.)"," ","C")) %>% 
...
") %>% 
  save_kable("meta_dl.html", bs_theme = "flatly")
